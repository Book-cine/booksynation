...
part 'vaccine_dtos.freezed.dart';
part 'vaccine_dtos.g.dart';

@freezed
abstract class VaccineDto implements _$VaccineDto {
  const VaccineDto._();
  ...
  factory VaccineDto.fromDomain(Vaccine vaccine) {
    return VaccineDto(
  ...
  factory VaccineDto.fromFirestore(AsyncSnapshot doc) {
